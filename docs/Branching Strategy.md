...
| :--- | :--- | :--- | :--- | :--- |
| **Feature** | `feature/` | `develop` | `develop` | `feature/wallet-connect-v2` |
| **Bugfix** | `fix/` | `develop` | `develop` | `fix/modal-alignment` |
| **Release** | `release/` | `develop` | `main` & `develop` | `release/v1.2.0` |
| **Hotfix** | `hotfix/` | `main` | `main` & `develop` | `hotfix/critical-overflow` |
...
- [ ] Local build passes
- [ ] Linter check passes
- [ ] (If Web3) Smart Contract interaction verified on Sepolia
```
